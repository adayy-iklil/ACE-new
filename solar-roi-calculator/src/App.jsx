    ...
    <div className="container" style={{ marginTop: '20px' }}>
      ...
      <div className="no-print">
        ...
        <div className="wizard-card">
          ...
          {/* STEP 3: REPORT & MCDM RECOMMENDATIONS */}
          {step === 3 && (
            <div>
              ...
              {calcResult && (
                <div className="indicator-grid">
                  <div className="indicator-box">
                    ...
                    <p className="text-neon" style={{ color: '#10b981' }}>{formatCurrency(calcResult.annualSavings / 12)}</p>
                  </div>
                  <div className="indicator-box">
              ...
              <div style={{ marginTop: '36px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                ...
                >
                  <i className="fas fa-file-pdf"></i> Unduh Laporan PDF Resmi (ACE logo)
                </button>
      ...
      <div className="print-only print-container">
        ...
        <div className="print-header">
          <div className="print-header-left">
            ...
            <div className="print-header-title">
              ...
              <p>Green Infrastructure & Solar PV EPC Leader · ISO 9001, 14001, 45001 Certified</p>
            </div>
          </div>
        ...
        <h2 style={{ textAlign: 'center', fontSize: '15pt', margin: '20px 0', textTransform: 'uppercase', fontFamily: 'Arial' }}>
