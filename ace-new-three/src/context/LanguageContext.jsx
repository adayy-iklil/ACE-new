...
const translations = {
    en: {
        nav: { home: 'Home', about: 'About', services: 'Services', projects: 'Projects', contact: 'Contact', calculator: 'Calculator', news: 'News' },
        hero: {
        ...
        footer: {
            ...
            copyright: 'PT. ACE ENERGY SERVICE. All rights reserved.',
            s1: 'Solar O&M',
            s2: 'Commercial EPC',
            s3: 'Residential EPC',
            s4: 'REC Management',
        ...
        calculator: {
            step1Label: 'Initial Info',
            step2Label: 'Technical Needs',
            step3Label: 'Recommendations',
            step1Title: 'Step 1: Initial Information',
            step1Desc: 'Please enter your name, phone, and active email to compile an official solar energy proposal.',
            clientNameLabel: 'Full Name / Company Name',
            clientNamePlaceholder: 'Enter your full name...',
            clientPhoneLabel: 'Phone Number / WhatsApp',
            clientPhonePlaceholder: 'Example: 087770051282',
            clientEmailLabel: 'Email Address',
            clientEmailPlaceholder: 'Example: name@domain.com',
            alertFillProfile: 'Please complete your Name, Phone Number, and Email profile first.',
            step2Title: 'Step 2: Technical Data & Power Consumption',
            step2Desc: 'Enter your clean roof area and utility power information to calculate the recommended solar capacity.',
            roofAreaLabel: 'Available Roof Area (m²)',
            roofAreaNote: 'Standard area: 1 kWp solar panel requires ± 5-6 m² of clean roof area.',
            gridCapacityLabel: 'PLN Grid Connection Capacity (VA)',
            monthlyBillLabel: 'Average Monthly Electricity Bill (IDR)',
            idealKwp: 'Ideal Capacity',
            maxKwp: 'Roof Limit',
            recKwp: 'Recommended Capacity',
            step3Title: 'Step 3: ROI Analysis & Product Ranking',
            step3Desc: 'ROI analysis completed. Below is the solar feasibility financial report and top solar product recommendations based on your inputs.',
            estSavings: 'Est. Monthly Savings',
            paybackPeriod: 'Payback Period',
            years: 'Years',
            co2Offset: 'CO2 Offset / Year',
            tons: 'Tons',
            selectedPanels: 'Selected Solar Panels Recommendations for You',
            price: 'Price',
            efficiency: 'Efficiency',
            warranty: 'Warranty',
            noProducts: 'No products passed the roof compatibility filter rules.',
            downloadPdf: 'Download Official PDF Report',
            consultationText: 'Want a free physical site survey and a customized official quotation from the ACE Engineering Team?',
            consultationLink: 'Click Here for Further Consultation',
            btnBack: 'Back',
            btnNext: 'Next',
            pdfTitle: 'SOLAR FEASIBILITY ANALYSIS REPORT',
            pdfDocNo: 'Document No.',
            pdfDate: 'Date',
            pdfSub: 'Technical Report on Solar Energy Investment Recommendation',
            pdfSec1: '1. General Client Information',
            pdfClientName: 'Client Name / Company',
            pdfClientPhone: 'Phone Number / WhatsApp',
            pdfClientEmail: 'Email Address',
            pdfSec2: '2. Technical Input Parameters',
            pdfParam: 'Input Parameter',
            pdfVal: 'Input Value',
            pdfDesc: 'Description',
            pdfRoofAreaDesc: 'Physical area allocated for PV panel installation.',
            pdfGridDesc: 'Active electricity grid capacity at the site.',
            pdfBillDesc: 'Basis for daily energy needs calculation.',
            pdfSec3: '3. Capacity Analysis & ROI Evaluation Results',
            pdfMetric: 'System Evaluation Metric',
            pdfEstVal: 'Estimated Value',
            pdfTechDesc: 'Technical Description',
            pdfRecKwpDesc: 'Optimal capacity adjusted to roof area & PLN grid capacity.',
            pdfAnnGen: 'Estimated Electricity Generation',
            pdfAnnGenDesc: 'Referring to average daily sun hours in Indonesia.',
            pdfAnnGenUnit: 'kWh / Year',
            pdfAnnSavings: 'Estimated Financial Savings',
            pdfAnnSavingsDesc: 'Or equivalent to {savings} / Month.',
            pdfPaybackDesc: 'Assuming average standard ACE system cost.',
            pdfCo2Desc: 'Green certification contributing to sustainability reporting.',
            pdfSec4: '4. Ranking of Best Solar Panel Product Recommendations',
            pdfSec4Note: 'Automatically sorted based on performance priority, manufacturer warranty duration, and economic investment value.',
            pdfRank: 'Rank',
            pdfPanelBrand: 'Panel Brand & Model',
            pdfTechSpec: 'Technical Specification',
            pdfEstPrice: 'Estimated Price',
            pdfCloseness: 'Compatibility Level',
            pdfFormNote: 'Note: To proceed with further consultation and scheduling a detailed physical survey, please contact the engineering team via the following Google Form questionnaire link: {url}',
            pdfCreatedBy: 'Prepared By,',
            pdfApprovedBy: 'Approved By,',
            pdfClientRep: 'Client Representative / Partner',
            pdfSigLine: 'Signature & Full Name',
            pdfSeniorTech: 'Senior Technician Engineer'
        }
    },
    id: {
        nav: { home: 'Beranda', about: 'Tentang', services: 'Layanan', projects: 'Proyek', contact: 'Kontak', calculator: 'Kalkulator', news: 'Berita' },
        hero: {
        ...
        footer: {
            ...
            copyright: 'PT. ACE ENERGY SERVICE. Hak cipta dilindungi.',
            s1: 'O&M Surya',
            s2: 'EPC Komersial',
            s3: 'EPC Residensial',
            s4: 'Manajemen REC',
        ...
        calculator: {
            step1Label: 'Informasi Awal',
            step2Label: 'Kebutuhan PLTS',
            step3Label: 'Hasil Rekomendasi',
            step1Title: 'Langkah 1: Informasi Awal',
            step1Desc: 'Harap masukkan nama, nomor telepon, dan email aktif Anda untuk menyusun proposal penawaran PLTS resmi.',
            clientNameLabel: 'Nama Lengkap / Nama Perusahaan',
            clientNamePlaceholder: 'Masukkan nama lengkap Anda...',
            clientPhoneLabel: 'Nomor Telepon / WhatsApp',
            clientPhonePlaceholder: 'Contoh: 087770051282',
            clientEmailLabel: 'Alamat Email',
            clientEmailPlaceholder: 'Contoh: nama@domain.com',
            alertFillProfile: 'Mohon lengkapi profil Nama, Nomor Telepon, dan Email terlebih dahulu.',
            step2Title: 'Langkah 2: Data Teknis & Konsumsi Listrik',
            step2Desc: 'Masukkan luas atap bersih dan informasi kelistrikan PLN Anda untuk menghitung kapasitas PLTS yang disarankan.',
            roofAreaLabel: 'Luas Atap yang Tersedia (m²)',
            roofAreaNote: 'Standard luas: 1 kWp panel surya membutuhkan ± 5-6 m² area atap bersih.',
            gridCapacityLabel: 'Sambungan Kontrak Daya Listrik PLN (VA)',
            monthlyBillLabel: 'Tagihan Listrik Rata-Rata Bulanan (IDR)',
            idealKwp: 'Kebutuhan Ideal',
            maxKwp: 'Batas Maks Atap',
            recKwp: 'Rekomendasi Kapasitas',
            step3Title: 'Langkah 3: Hasil Analisis ROI & Pemeringkatan Produk',
            step3Desc: 'Analisis ROI telah selesai. Berikut adalah laporan finansial kelayakan PLTS dan rekomendasi produk surya terbaik berdasarkan masukan Anda.',
            estSavings: 'Estimasi Hemat Bulanan',
            paybackPeriod: 'Masa Balik Modal',
            years: 'Tahun',
            co2Offset: 'Reduksi CO2 / Tahun',
            tons: 'Ton',
            selectedPanels: 'Rekomendasi Panel Surya Terpilih untuk Anda',
            price: 'Harga',
            efficiency: 'Efisiensi',
            warranty: 'Garansi',
            noProducts: 'Tidak ada produk yang lolos filtering aturan kecocokan atap.',
            downloadPdf: 'Unduh Laporan PDF Resmi',
            consultationText: 'Ingin survei lokasi fisik secara gratis dan penawaran harga resmi yang disesuaikan dari Tim Engineering ACE?',
            consultationLink: 'Klik Selengkapnya Untuk Konsultasi Lebih Lanjut',
            btnBack: 'Kembali',
            btnNext: 'Lanjutkan',
            pdfTitle: 'LAPORAN ANALISIS KELAYAKAN PLTS',
            pdfDocNo: 'No Dokumen',
            pdfDate: 'Tanggal',
            pdfSub: 'Laporan Teknis Rekomendasi Investasi Energi Surya',
            pdfSec1: '1. Informasi Umum Klien',
            pdfClientName: 'Nama Klien / Perusahaan',
            pdfClientPhone: 'Nomor Telepon / WhatsApp',
            pdfClientEmail: 'Alamat Email',
            pdfSec2: '2. Parameter Masukan Teknis',
            pdfParam: 'Parameter Masukan',
            pdfVal: 'Nilai Input',
            pdfDesc: 'Keterangan',
            pdfRoofAreaDesc: 'Luas fisik yang dialokasikan untuk instalasi panel PV.',
            pdfGridDesc: 'Kapasitas jaringan daya listrik aktif di lokasi.',
            pdfBillDesc: 'Dasar perhitungan kebutuhan energi harian.',
            pdfSec3: '3. Hasil Analisis Kapasitas & Evaluasi ROI',
            pdfMetric: 'Metrik Evaluasi Sistem',
            pdfEstVal: 'Nilai Estimasi',
            pdfTechDesc: 'Keterangan Teknis',
            pdfRecKwpDesc: 'Kapasitas optimal yang disesuaikan luas atap & daya PLN.',
            pdfAnnGen: 'Estimasi Produksi Energi Listrik',
            pdfAnnGenDesc: 'Mengacu pada sun hours harian rata-rata di Indonesia.',
            pdfAnnGenUnit: 'kWh / Tahun',
            pdfAnnSavings: 'Estimasi Penghematan Finansial',
            pdfAnnSavingsDesc: 'Atau setara dengan {savings} / Bulan.',
            pdfPaybackDesc: 'Asumsi biaya sistem rata-rata standar ACE.',
            pdfCo2Desc: 'Sertifikasi hijau kontribusi pelaporan keberlanjutan.',
            pdfSec4: '4. Urutan Rekomendasi Produk Panel Surya Terbaik',
            pdfSec4Note: 'Diurutkan secara otomatis berdasarkan prioritas performa, durasi garansi pabrikan, dan nilai ekonomis investasi.',
            pdfRank: 'Peringkat',
            pdfPanelBrand: 'Merek & Model Panel',
            pdfTechSpec: 'Spesifikasi Teknis',
            pdfEstPrice: 'Estimasi Harga',
            pdfCloseness: 'Tingkat Kecocokan',
            pdfFormNote: 'Catatan: Untuk melakukan konsultasi lanjutan dan penjadwalan survei fisik terperinci, silakan hubungi tim teknik melalui tautan kuesioner Google Form berikut: {url}',
            pdfCreatedBy: 'Dibuat Oleh,',
            pdfApprovedBy: 'Disetujui Oleh,',
            pdfClientRep: 'Perwakilan Klien / Kemitraan',
            pdfSigLine: 'Tanda Tangan & Nama Terang',
            pdfSeniorTech: 'Technician Engineer Senior'
        }
    },
    ko: {
        ...
        footer: {
            ...
            services: '서비스',
            contactUs: '문의',
            copyright: 'PT. ACE ENERGY SERVICE. 모든 권리 보유.',
            s1: '태양광 O&M',
            s2: '상업용 EPC',
            s3: '주거용 EPC',
            s4: 'REC 관리',
        ...
        calculator: {
            ...
            step1Desc: '공식 태양광 제안서 작성을 위해 이름, 전화번호 및 이메일을 입력해 주세요.',
            clientNameLabel: '성명 / 회사명',
            clientNamePlaceholder: '성명을 입력해 주세요...',
            clientPhoneLabel: '전화번호 / WhatsApp',
            clientPhonePlaceholder: '예: 087770051282',
            clientEmailLabel: '이메일 주소',
            clientEmailPlaceholder: '예: name@domain.com',
            alertFillProfile: '먼저 이름, 전화번호, 이메일 정보를 입력해 주세요.',
            step2Title: '2단계: 기술 데이터 및 전력 소비량',
            step2Desc: '권장 태양광 용량을 계산하기 위해 가용 지붕 면적과 한전(PLN) 계약 전력 정보를 입력해 주세요.',
            roofAreaLabel: '가용 지붕 면적 (m²)',
            roofAreaNote: '표준 면적: 태양광 패널 1 kWp 설치 시 약 5-6 m²의 빈 지붕 공간이 필요합니다.',
            gridCapacityLabel: 'PLN 계약 전력 용량 (VA)',
            monthlyBillLabel: '월평균 전기 요금 (IDR)',
            idealKwp: '이상적 용량',
            maxKwp: '지붕 한계',
            recKwp: '권장 용량',
            step3Title: '3단계: ROI 분석 및 제품 순위',
            step3Desc: 'ROI 분석이 완료되었습니다. 입력하신 정보를 바탕으로 한 태양광 타당성 재무 보고서 및 최적의 제품 추천 결과입니다.',
            estSavings: '월간 예상 절감액',
            paybackPeriod: '투자 회수 기간',
            years: '년',
            co2Offset: '연간 CO2 감축량',
            tons: '톤',
            selectedPanels: '고객님을 위한 추천 태양광 패널',
            price: '가격',
            efficiency: '효율',
            warranty: '보증',
            noProducts: '지붕 호환성 필터 규칙을 통과한 제품이 없습니다.',
            downloadPdf: '공식 PDF 보고서 다운로드',
            consultationText: 'ACE 엔지니어링 팀의 무료 현장 실사 및 맞춤형 공식 견적을 원하십니까?',
            consultationLink: '추가 상담을 위해 여기를 클릭하세요',
            btnBack: '이전',
            btnNext: '다음',
            pdfTitle: '태양광 발전 타당성 분석 보고서',
            pdfDocNo: '문서 번호',
            pdfDate: '일자',
            pdfSub: '태양광 에너지 투자 추천 기술 보고서',
            pdfSec1: '1. 고객 일반 정보',
            pdfClientName: '고객명 / 회사명',
            pdfClientPhone: '전화번호 / WhatsApp',
            pdfClientEmail: '이메일 주소',
            pdfSec2: '2. 기술 입력 매개변수',
            pdfParam: '입력 항목',
            pdfVal: '입력값',
            pdfDesc: '설명',
            pdfRoofAreaDesc: '태양광 패널 설치를 위해 할당된 물리적 면적입니다.',
            pdfGridDesc: '해당 사이트의 활성 전력 그리드 용량입니다.',
            pdfBillDesc: '일일 에너지 요구량 계산의 기준입니다.',
            pdfSec3: '3. 용량 분석 및 ROI 평가 결과',
            pdfMetric: '시스템 평가 지표',
            pdfEstVal: '추정값',
            pdfTechDesc: '기술적 설명',
            pdfRecKwpDesc: '지붕 면적 및 PLN 계약 전력에 맞게 조정된 최적의 용량입니다.',
            pdfAnnGen: '예상 발전량',
            pdfAnnGenDesc: '인도네시아의 일평균 일조 시간을 기준으로 합니다.',
            pdfAnnGenUnit: 'kWh / 년',
            pdfAnnSavings: '예상 재무 절감액',
            pdfAnnSavingsDesc: '또는 월 {savings} 상당.',
            pdfPaybackDesc: 'ACE 표준 평균 시스템 비용을 가정한 것입니다.',
            pdfCo2Desc: '지속가능성 보고에 기여하는 친환경 인증입니다.',
            pdfSec4: '4. 최적의 태양광 패널 제품 추천 순위',
            pdfSec4Note: '성능 우수성, 제조업체 보증 기간 및 투자 경제성을 기준으로 자동 정렬되었습니다.',
            pdfRank: '순위',
            pdfPanelBrand: '패널 브랜드 및 모델',
            pdfTechSpec: '기술 사양',
            pdfEstPrice: '예상 가격',
            pdfCloseness: '적합도',
            pdfFormNote: '참고: 추가 상담 및 상세 현장 실사 일정을 잡으려면 다음 Google 설문지 링크를 통해 엔지니어링 팀에 문의하십시오: {url}',
            pdfCreatedBy: '작성자:',
            pdfApprovedBy: '승인자:',
            pdfClientRep: '고객 대표 / 파트너',
            pdfSigLine: '서명 및 성명',
            pdfSeniorTech: '수석 기술 엔지니어'
        }
    }
};
