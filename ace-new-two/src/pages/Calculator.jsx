  ...
  return (
    <div className="calc-container">
            ...
            <div>
              ...
              <div className="form-grid">
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  ...
                  />
                  <span style={{ fontSize: '0.8rem', color: '#94a3b8' }}>{t('calc_roofAreaNote')}</span>
                </div>
                <div className="form-group">
            ...
            <div>
              ...
              <div className="mcdm-results">
                {rankedProducts.length > 0 ? (
                  ...
                  <p style={{ color: '#94a3b8' }}>{t('calc_noProducts')}</p>
                )}
              </div>
      ...
      <div className="print-only print-container">
        ...
        <div className="print-section-title">{t('calc_pdfSec1')}</div>
        ...
        <div className="print-section-title">{t('calc_pdfSec2')}</div>
        ...
        {/* Section 3: ROI Math */}
        <div className="print-section-title">{t('calc_pdfSec3')}</div>
        {calcResult && (
          <table className="print-table">
            <thead>
              <tr>
        ...
        <div className="print-section-title">{t('calc_pdfSec4')}</div>
